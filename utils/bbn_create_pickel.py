...
def bbn_images2pkl(dtype='test', ytype='2020'):
    ...
    img_dir = 'G:/PythonWorkplace/HCP-MIC-at-ImageCLEF-VQA-Med-2020-master/data2020/' + dtype + ytype + '/images'
    img_id2idx_path = 'G:/PythonWorkplace/HCP-MIC-at-ImageCLEF-VQA-Med-2020-master/data2020/train2020/trainimgid2idx.json'
    ...
    path = dtype + str(size) + 'x' + str(size) + 'clip.pkl'
    path = 'G:/PythonWorkplace/HCP-MIC-at-ImageCLEF-VQA-Med-2020-master/data2020/' + str(size) + 'x' + str(size) + 'imageclip,pkl'
    with open(path, 'wb') as f:
        pickle.dump(final_np, f)


if __name__ == "__main__":
    bbn_images2pkl(dtype='train', ytype='2020')
