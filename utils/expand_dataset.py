...
def train2dict(dtype='train', ytype='2020'):
    name_dict = {}
    path = 'data/' + dtype + ytype + '/All_QA_Pairs_' + dtype + '.txt'
    path = 'G:/PythonWorkplace/HCP-MIC-at-ImageCLEF-VQA-Med-2020-master/data2020/'
    with open(path + dtype + ytype + '/All_QA_Pairs_' + dtype + '.txt', 'r') as o:
        lines = o.readlines()
